    ...
    <aside className="hidden md:flex fixed inset-y-0 left-0 z-50 w-68 flex-col border-r border-slate-200 bg-white shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex flex-col gap-6 border-b border-slate-100 px-6 py-8">
        ...
        <Link to="/app/home" className="group flex items-center gap-3 w-fit">
          ...
          <span className="text-xl font-black tracking-tight text-slate-900 transition-colors group-hover:text-primary-glow">
            Renderways
          </span>
        </Link>

        {/* User Interactive Menu Button */}
        <button className="button-plain group flex w-full items-center justify-between overflow-hidden rounded-2xl border border-slate-100 bg-slate-50 p-3 transition-colors duration-300 hover:border-slate-200 hover:bg-slate-100 text-left">
          <div className="flex items-center gap-3 relative z-10 min-w-0">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-slate-200 text-slate-500 font-bold transition-colors group-hover:bg-primary-glow/10 group-hover:text-primary-glow">
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-2xl bg-primary-glow/10"
                  initial={false}
                  transition={{ 
                    type: "spring", 
                    stiffness: 350, 
