      ...
      <div className="flex items-center space-x-4 md:space-x-6">
        ...
        <div className="relative hidden md:block">
          <input 
            type="text" 
            placeholder="Search..." 
            className="bg-gray-50 border border-gray-200 text-gray-700 rounded-lg px-4 py-2 w-48 lg:w-64 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm transition-all shadow-inner"
          />
        ...
        {/* Notification icon */}
        <button className="text-gray-500 hover:text-indigo-600 relative transition-colors focus:outline-none p-1 rounded-full hover:bg-indigo-50">
        ...
        <div className="relative" ref={dropdownRef}>
          <button 
            className="flex items-center space-x-3 cursor-pointer focus:outline-none rounded-full ring-2 ring-transparent hover:ring-indigo-100 transition-all"
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50 transform opacity-100 scale-100 transition-all origin-top-right">
              ...
              <div className="py-1">
                ...
                <button 
                  className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                  onClick={() => setIsDropdownOpen(false)}
                >
